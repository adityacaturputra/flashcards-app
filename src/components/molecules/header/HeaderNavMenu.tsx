          ...
          >
            <div className='p-3 sm:p-4 flex flex-col gap-3'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <button
                  onClick={() => onNavigate(APP_ROUTES.REBUTTAL)}
                  className='group flex items-center justify-between rounded-xl p-2.5 text-left transition-all hover:bg-slate-100 dark:hover:bg-slate-800'
                >
                  <div className='flex items-center gap-3'>
                    <div className='flex h-9 w-9 items-center justify-center rounded-lg bg-teal-500/10 text-teal-600 dark:text-teal-400 group-hover:scale-105 transition-transform'>
                    ...
                    <div className='flex flex-col items-start text-left'>
                      ...
                      <div className='text-xs text-muted-foreground text-left'>
                        Deteksi jebakan sanggahan & audio Cambridge
                      </div>
                    </div>
                  </div>
                  <FaChevronRight className='h-3 w-3 text-muted-foreground opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all' />
                ...
                {/* Cambridge Mock Tests (PDF & Audio) */}
                <button
                  onClick={() => onNavigate(APP_ROUTES.CAMBRIDGE_TESTS)}
                  className='group flex items-center justify-between rounded-xl p-2.5 text-left transition-all hover:bg-slate-100 dark:hover:bg-slate-800'
                >
                  <div className='flex items-center gap-3'>
                    <div className='flex h-9 w-9 items-center justify-center rounded-lg bg-rose-500/10 text-rose-600 dark:text-rose-400 group-hover:scale-105 transition-transform'>
                    ...
                    <div className='flex flex-col items-start text-left'>
                      <div className='flex items-center gap-1.5 text-left'>
                        ...
                        <span className='rounded-md bg-rose-500/10 text-rose-600 dark:text-rose-400 px-1.5 py-0.2 text-[9px] font-bold uppercase'>
                          PDF & Audio
                        </span>
                      </div>
                      <div className='text-xs text-muted-foreground text-left'>
                        Buku Cambridge 11–19, PDF simulasi & floating audio
                      </div>
                    </div>
                  </div>
                  <FaChevronRight className='h-3 w-3 text-muted-foreground opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all' />
