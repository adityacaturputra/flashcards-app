...
import { SyncCardDiff, SYNC_CARD_STATUS } from '@/types/sync';
...
export const SyncDiffViewer: React.FC<SyncDiffViewerProps> = ({
  ...
  const isLocalOnly = item.status === SYNC_CARD_STATUS.LOCAL_ONLY;
  ...
  return (
    ...
    >
      ...
      <div className='flex items-start justify-between gap-2'>
        ...
        >
          {isLocalOnly ? 'Local Only' : 'Cloud Only'}
        </span>
      </div>
      ...
      {item.status === SYNC_CARD_STATUS.CLOUD_ONLY && (
